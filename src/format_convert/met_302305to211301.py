...
#            <From 3.02/3.03/3.04/3.05 to 2.11/3.00/3.01>       * |
# *                                                             * |
...
def MET_RINEX302305_to_RINEX211301(input_file_path, target_version):
    ...
    for row_line in iter_copy_raw_rinex_text_list:
        ...
        if len(lines_text[1:4].strip()) == 3:
            added_lines_text = ' ' + lines_text[3:]
        else:
