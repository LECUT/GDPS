...
class Met_RINEX_Conversion(QMainWindow):
    global input_file_version
    def __init__(self, ratio):
        super().__init__()
        self.ratio = ratio
        self.setWindowTitle("Meteorolog Data")
    ...
    def setup_ui(self):
        ...
        # self.setMaximumSize(QSize(900, 200))
    ...
    def check_version_button_group_change(self, id):
        try:
            ...
            if input_file_version == '2.10':
                if id == 211:
                    output_file_name = 'vc_' + head1 + '.' + tail1
                else:
                    output_file_name = head1[0:4].upper() + '00XXX_R_20' + tail1[0:2] + head1[4:7] + '0000_01D_05M_MM.rnx'
                ...
                if id == 210 or id == 211:
                    output_file_name = head1[0:4].lower() + head1[16:19] + head1[20:21] + '.' + head1[14:16] + 'm'
                else:
                    output_file_name = 'VC_' + head1[0:4].upper() + '00XXX_R_20' + tail1[0:2] + head1[4:7] + '0000_01D_05M_MM.rnx'
    ...
    def save_input_files_path_function(self):
        ...
        if os.path.exists(unzip_default_download_path):
            path1, parh2 = QFileDialog.getOpenFileName(self, 'Select the file', './', 'm_file(*MM.rnx *.*m *.*M);;All_File(*)')
        else:
            path1, parh2 = QFileDialog.getOpenFileName(self, 'Select the file', './', 'm_file(*MM.rnx *.*m *.*M);;All_File(*)')
        ...
        # self.cheack210.setCheckable(True)
        ...
        # self.cheack210.setEnabled(True)
        ...
        # self.cheack210.setChecked(False)
        ...
        if parh2 == '':
            ...
            try:
                with open(path1, 'r') as f00:
                    ...
                    if 'MET' not in first_line[20:40].upper():
                ...
                # if input_file_version == '2.10':
                #     self.cheack210.setEnabled(False)
                if input_file_version == '2.11' or input_file_version == '3.00' or input_file_version == '3.01':
                    self.cheack211.setEnabled(False)
                    self.cheack300.setEnabled(False)
                    self.cheack301.setEnabled(False)
                elif input_file_version == '3.02' or input_file_version == '3.03' or input_file_version == '3.04' or input_file_version == '3.05':
    ...
    def convert_function(self):
        ...
        if target_version:
            try:
                T1 = time.time()
                #
                if target_version == '2.10':
                    if input_file_version == '2.11' or input_file_version == '3.00' or input_file_version == '3.01':
                        convert_list = met_211301to210.MET_RINEX211301_to_RINEX210(input_path, target_version)
                    elif input_file_version == '3.02' or input_file_version == '3.03' or input_file_version == '3.04' or input_file_version == '3.05':
                        convert_list = met_302305to210.MET_RINEX302305_to_RINEX210(input_path, target_version)
                    elif input_file_version == '4.00' or target_version == '4.01':
                        convert_list = met_4to210.MET_RINEX4_to_RINEX210(input_path, target_version)
                        pass
                elif target_version == '2.11' or target_version == '3.00' or target_version == '3.01':
                    if input_file_version == '2.10':
                        convert_list = met_210to234.MET_RINEX210_to_EINEX234(input_path, target_version)
                    elif input_file_version == '3.02' or input_file_version == '3.03' or input_file_version == '3.04' or input_file_version == '3.05':
                        convert_list = met_302305to211301.MET_RINEX302305_to_RINEX211301(input_path, target_version)
                    elif input_file_version == '4.00' or target_version == '4.01':
                        convert_list = met_4to211305.MET_RINEX4_to_RINEX211305(input_path, target_version)
                        pass
                elif target_version == '3.02' or target_version == '3.03' or target_version == '3.04' or target_version == '3.05':
                    if input_file_version == '2.10':
                        convert_list = met_210to234.MET_RINEX210_to_EINEX234(input_path, target_version)
                    elif input_file_version == '2.11' or input_file_version == '3.00' or input_file_version == '3.01':
                        convert_list = met_211301to302400.MET_RINEX211301_to_RINEX302400(input_path, target_version)
                    elif input_file_version == '4.00' or target_version == '4.01':
                        convert_list = met_4to211305.MET_RINEX4_to_RINEX211305(input_path, target_version)
                        pass
                    ...
                    if input_file_version == '2.10':
                        ...
                        convert_list = met_302305to4.MET_RINEX302305_to_RINEX4(input_path, target_version)
            except:
...
class Look_Over_File_details(QWidget):
    def __init__(self, converted_file, ratio):
        ...
        self.setWindowIcon(QIcon(':/icon/logo.ico'))
        self.resize(400*self.ratio , 300*self.ratio )
    ...
    def setup_ui(self, converted_file):
        ...
        # self.textEdit.setGeometry(0, 0, 1000, 800)
...
if __name__ == '__main__':
    ...
    print(dpi)
    ratio = dpi/96
    win = Met_RINEX_Conversion(ratio)
    font = QFont()
